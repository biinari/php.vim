...
" @block('Last-modified')
"
" Sun, 30 Jun 2024 23:40:17 +0000, PHP 5.6.40, 7.0.33, 7.1.33, 7.2.34, 7.3.33, 7.4.33, 8.0.30, 8.1.29, 8.2.20
"
" @endblock
"
...
syn keyword phpClasses AllowDynamicProperties ArgumentCountError ArithmeticError ArrayAccess Attribute BackedEnum ClosedGeneratorException Closure CompileError Countable DivisionByZeroError Error ErrorException Exception Fiber FiberError Generator InternalIterator Iterator IteratorAggregate ParseError ReturnTypeWillChange SensitiveParameter SensitiveParameterValue Serializable Stringable Throwable Traversable TypeError UnhandledMatchError UnitEnum ValueError WeakMap WeakReference stdClass contained
endif
if index(g:php_syntax_extensions_enabled, "curl") >= 0 && index(g:php_syntax_extensions_disabled, "curl") < 0 && ( ! exists("b:php_syntax_extensions_enabled") || index(b:php_syntax_extensions_enabled, "curl") >= 0) && ( ! exists("b:php_syntax_extensions_disabled") || index(b:php_syntax_extensions_disabled, "curl") < 0)
" curl functions
