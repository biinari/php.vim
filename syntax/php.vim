...
" @block('Last-modified')
"
" Sat, 15 Jun 2024 03:22:32 +0000, PHP 5.6.40, 7.0.33, 7.1.33, 7.2.34, 7.3.33, 7.4.33, 8.0.30
"
" @endblock
"
...
syn keyword phpConstants IS_ABSTRACT IS_DEPRECATED IS_EXPLICIT_ABSTRACT IS_FINAL IS_IMPLICIT_ABSTRACT IS_INSTANCEOF IS_PRIVATE IS_PROTECTED IS_PUBLIC IS_STATIC contained
endif
...
syn keyword phpClasses ArgumentCountError ArithmeticError ArrayAccess Attribute ClosedGeneratorException Closure CompileError Countable DivisionByZeroError Error ErrorException Exception Generator InternalIterator Iterator IteratorAggregate ParseError Serializable Stringable Throwable Traversable TypeError UnhandledMatchError ValueError WeakMap WeakReference stdClass contained
endif
if index(g:php_syntax_extensions_enabled, "curl") >= 0 && index(g:php_syntax_extensions_disabled, "curl") < 0 && ( ! exists("b:php_syntax_extensions_enabled") || index(b:php_syntax_extensions_enabled, "curl") >= 0) && ( ! exists("b:php_syntax_extensions_disabled") || index(b:php_syntax_extensions_disabled, "curl") < 0)
" curl functions
...
syn keyword phpClasses CURLFile CurlHandle CurlMultiHandle CurlShareHandle contained
endif
if index(g:php_syntax_extensions_enabled, "date") >= 0 && index(g:php_syntax_extensions_disabled, "date") < 0 && ( ! exists("b:php_syntax_extensions_enabled") || index(b:php_syntax_extensions_enabled, "date") >= 0) && ( ! exists("b:php_syntax_extensions_disabled") || index(b:php_syntax_extensions_disabled, "date") < 0)
" date functions
...
syn keyword phpClasses GdImage contained
endif
...
syn keyword phpClasses Reflection ReflectionAttribute ReflectionClass ReflectionClassConstant ReflectionException ReflectionExtension ReflectionFunction ReflectionFunctionAbstract ReflectionGenerator ReflectionMethod ReflectionNamedType ReflectionObject ReflectionParameter ReflectionProperty ReflectionReference ReflectionType ReflectionUnionType ReflectionZendExtension Reflector contained
endif
if index(g:php_syntax_extensions_enabled, "session") >= 0 && index(g:php_syntax_extensions_disabled, "session") < 0 && ( ! exists("b:php_syntax_extensions_enabled") || index(b:php_syntax_extensions_enabled, "session") >= 0) && ( ! exists("b:php_syntax_extensions_disabled") || index(b:php_syntax_extensions_disabled, "session") < 0)
" session functions
