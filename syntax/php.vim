...
" @block('Last-modified')
"
" Sat, 15 Jun 2024 20:28:51 +0000, PHP 5.6.40, 7.0.33, 7.1.33, 7.2.34, 7.3.33, 7.4.33, 8.0.30, 8.1.29
"
" @endblock
"
...
syn keyword phpClasses ArgumentCountError ArithmeticError ArrayAccess Attribute BackedEnum ClosedGeneratorException Closure CompileError Countable DivisionByZeroError Error ErrorException Exception Fiber FiberError Generator InternalIterator Iterator IteratorAggregate ParseError ReturnTypeWillChange Serializable Stringable Throwable Traversable TypeError UnhandledMatchError UnitEnum ValueError WeakMap WeakReference stdClass contained
endif
if index(g:php_syntax_extensions_enabled, "curl") >= 0 && index(g:php_syntax_extensions_disabled, "curl") < 0 && ( ! exists("b:php_syntax_extensions_enabled") || index(b:php_syntax_extensions_enabled, "curl") >= 0) && ( ! exists("b:php_syntax_extensions_disabled") || index(b:php_syntax_extensions_disabled, "curl") < 0)
" curl functions
...
" Types
syn keyword phpType bool[ean] int[eger] real double float string array object self parent global this stdClass callable iterable void mixed contained
" Special values
